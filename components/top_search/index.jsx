...
const ALL_PAGES = [
  ...
  { id: 'p6', name: 'HTTP Status Codes', path: '/http_status_codes' },
  { id: 'p7', name: 'JSON Formatter', path: '/json_format' },
  { id: 'p8', name: 'JSON to YAML', path: '/json_to_yaml' },
  { id: 'p9', name: 'Lorem Ipsum Generator', path: '/lorem_ipsum' },
  { id: 'p10', name: 'Markdown Preview', path: '/markdown_preview' },
  { id: 'p11', name: 'Password Generator', path: '/password_generator' },
  { id: 'p12', name: 'QR Code Generator', path: '/qr_code' },
  { id: 'p13', name: 'RGB to Hex', path: '/rgb_to_hex' },
