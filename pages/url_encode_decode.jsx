...
function UrlEncodeDecode() {
  ...
  return (
    <>
      <Head>
        <title>URL Encode/Decode - Fawkes</title>
      </Head>
      {showToast && <Toast message="Output added to clipboard" />}
      <div className="text-center mb-4">URL Encode/Decode</div>
      ...
      <div className="flex flex-col">
        ...
        <textarea
          className="transition w-full p-2 border border-gray-300 rounded-md h-56 font-mono text-sm border resize-none bg-white dark:bg-gray-600 dark:border-gray-500"
          value={output}
          disabled
        />
      </div>
