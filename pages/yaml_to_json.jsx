...
function YamlToJson() {
  ...
  return (
    <>
      <Head>
        <title>YAML to JSON - Fawkes</title>
      </Head>
      {showToast && <Toast message="Output added to clipboard" />}
      <div className="text-center mb-4">YAML to JSON</div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <div className="mt-4">
            ...
            />
            {!isInputValid && (
              <span className="text-red-600">The input is not valid YAML</span>
            )}
          </div>
        </div>
        <div>
          ...
          <div className="mt-4">
            <pre
              className="transition w-full p-2 border border-gray-300 overflow-auto rounded-md font-mono text-xs whitespace-pre border resize-none bg-white dark:bg-gray-600 dark:border-gray-500"
              style={{ height: 'calc(100vh - 12rem)' }}
            >
