...
function MarkdownPreview() {
  ...
  return (
    <>
      <Head>
        <title>Markdown Preview - Fawkes</title>
      </Head>
      {showToast && <Toast message="Output added to clipboard" />}
      <div className="text-center mb-4">Markdown Preview</div>
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="mt-4">
            <div
              className="transition w-full p-2 overflow-auto rounded-md text-sm border resize-none border border-gray-300 bg-white dark:bg-gray-600 dark:border-gray-500 prose prose-sm prose-blue dark:prose-light max-w-none"
              style={{ height: 'calc(100vh - 12rem)' }}
