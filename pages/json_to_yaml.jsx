...
function JsonToYaml() {
  ...
  function handleConvert() {
    ...
    try {
      ...
      const parsedOutput = yaml.dump(parsedInput);
  ...
  return (
    <>
      <Head>
        <title>JSON to YAML - Fawkes</title>
      </Head>
      {showToast && <Toast message="Output added to clipboard" />}
      <div className="text-center mb-4">JSON to YAML</div>
        ...
        <div>
          ...
          <div className="mt-4">
            <textarea
              ...
              cols="30"
              rows="10"
              className="transition w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:border-blue-300 font-mono text-xs border resize-none bg-white dark:bg-gray-600 dark:border-gray-500"
